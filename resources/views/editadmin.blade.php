          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="row">
                ...
                <form action="{{url('editadmin/'.$data->AdminID)}}" method="post">
                  @csrf
                <div class="col-xxl">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control" name="NamaLengkap" value="{{$data->NamaLengkap}}"  />
                          </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control" name="NomorTelepon" value="{{$data->Telepon}}" />
                          </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="mb-3 row">
                          ...
                          <div class="col-10">
                          <select class="form-select" id="validationCustom04" name="Akses" value="{{$data->Akses}}" >
