        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 mb-4"><span class="text-muted fw-light">Tabel / </span> Data Pelanggan </h4>
              ...
              <div class="card">
                <div class="demo-inline-spacing d-flex justify-content-end mx-2">
                  <a class="btn btn-primary" href="{{url('tambahpelanggan')}}"  role="button">Tambah</a>
                </div>
                <div class="card-body">
                  <div class="table-responsive text-nowrap">
                    <table class="table table-bordered">
                      ...
                      <tbody>
                          ...
                          <tr>
                            <td>{{$inem->PelangganID}}</td>
                            <td>{{$inem->NamaPelanggan}}</td>
                            <td>{{$inem->Alamat}}</td>
                            <td>{{$inem->NomorTelepon}}</td>
                            <td>
                                <div class="dropdown">
                                  <button
                                    type="button"
                                  ...
                                  <div class="dropdown-menu">
                                    <a href="{{url('editpelanggan/'.$inem->PelangganID)}}" class="dropdown-item"
                                      ><i class="bx bx-edit-alt me-1"></i> Edit</a
                                    >
                                    <a href="{{url('hapuspelanggan/'.$inem->PelangganID)}}" class="dropdown-item"
